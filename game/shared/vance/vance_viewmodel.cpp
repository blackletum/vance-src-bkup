...
void CVanceViewModel::CalcViewModelBasePose(Vector& origin, QAngle& angles, CBasePlayer* owner)
{
	...
	origin += right * sinf((flSprintBobTimeline + 0.25f) * 6.28318) * 0.7f * m_flSprintBob * cl_vm_dynsprintbob_intensity.GetFloat(); //main side to side sway
	origin += up * ((-cosf((flSprintBobTimeline - 0.25f)*12.56636f) + sinf((flSprintBobTimeline - 0.25f)*6.28318) * 0.2f) + 0.8f * (-cosf((flSprintBobTimeline - 0.25f)*12.56636f) + sinf((flSprintBobTimeline - 0.25f)*6.28318) * 0.2f)) * 0.3f * m_flSprintBob * cl_vm_dynsprintbob_intensity.GetFloat();//step jolts
	angles.z += sinf(((flSprintBobTimeline + 0.1 - floorf(flSprintBobTimeline + 0.1)) + 0.25f) * 6.28318) * 2.0f * m_flSprintBob * cl_vm_dynsprintbob_intensity.GetFloat(); //rotational sway
	origin += up * sinf(((flSprintBobTimeline + 0.1 - floorf(flSprintBobTimeline + 0.1)) + 0.25f) * 6.28318) * 0.28f * m_flSprintBob * cl_vm_dynsprintbob_intensity.GetFloat(); //vertical sway to counteract rotational sway
	origin += up * cl_vm_dynsprintbob_static_verticaloffset.GetFloat() * m_flSprintBob * cl_vm_dynsprintbob_intensity.GetFloat(); //static down
	origin += right * cl_vm_dynsprintbob_static_horizontaloffset.GetFloat() * m_flSprintBob * cl_vm_dynsprintbob_intensity.GetFloat(); //and to the left
	angles.y += cl_vm_dynsprintbob_static_rotoffset.GetFloat() * m_flSprintBob * cl_vm_dynsprintbob_intensity.GetFloat(); //also yeah a bit too much also you should rotate it too like rotate it to the left
	...
	origin += right * sinf((flWalkBobTimeline + 0.25f) * 6.28318) * 0.45f * m_flWalkBob * cl_vm_dynsprintbob_intensity.GetFloat(); //main side to side sway
	origin += up * ((-cosf((flWalkBobTimeline - 0.25f)*12.56636f) + sinf((flWalkBobTimeline - 0.25f)*6.28318) * 0.2f) + 0.8f * (-cosf((flWalkBobTimeline - 0.25f)*12.56636f) + sinf((flWalkBobTimeline - 0.25f)*6.28318) * 0.2f)) * 0.15f * m_flWalkBob * cl_vm_dynsprintbob_intensity.GetFloat();//step jolts
	angles.z += sinf(((flWalkBobTimeline + 0.05 - floorf(flWalkBobTimeline + 0.05)) + 0.25f) * 6.28318) * 1.5f * m_flWalkBob * cl_vm_dynsprintbob_intensity.GetFloat(); //rotational tilt sway
	origin += up * sinf(((flWalkBobTimeline + 0.05 - floorf(flWalkBobTimeline + 0.05)) + 0.25f) * 6.28318) * 0.21f * m_flWalkBob * cl_vm_dynsprintbob_intensity.GetFloat(); //vertical sway to counteract rotational tilt sway
	flWalkBobTimeline = flWalkBobTimeline - 0.05 - floorf(flWalkBobTimeline - 0.05); //offset it for the rotation step jolts
	angles.x += ((-cosf((flWalkBobTimeline - 0.25f)*12.56636f) + sinf((flWalkBobTimeline - 0.25f)*6.28318) * 0.2f) + 0.8f * (-cosf((flWalkBobTimeline - 0.25f)*12.56636f) + sinf((flWalkBobTimeline - 0.25f)*6.28318) * 0.2f)) * 0.15f * m_flWalkBob * cl_vm_dynsprintbob_intensity.GetFloat();//rotation step jolts
	...
	origin += right * sinf((flCrouchWalkBobTimeline + 0.25f) * 6.28318) * 0.45f * m_flCrouchWalkBob * cl_vm_dynsprintbob_intensity.GetFloat(); //main side to side sway
	origin += up * ((-cosf((flCrouchWalkBobTimeline - 0.25f)*12.56636f) + sinf((flCrouchWalkBobTimeline - 0.25f)*6.28318) * 0.2f) + 0.8f * (-cosf((flCrouchWalkBobTimeline - 0.25f)*12.56636f) + sinf((flCrouchWalkBobTimeline - 0.25f)*6.28318) * 0.2f)) * 0.15f * m_flCrouchWalkBob * cl_vm_dynsprintbob_intensity.GetFloat();//step jolts
	angles.z += sinf(((flCrouchWalkBobTimeline + 0.05 - floorf(flCrouchWalkBobTimeline + 0.05)) + 0.25f) * 6.28318) * 1.5f * m_flCrouchWalkBob * cl_vm_dynsprintbob_intensity.GetFloat(); //rotational tilt sway
	origin += up * sinf(((flCrouchWalkBobTimeline + 0.05 - floorf(flCrouchWalkBobTimeline + 0.05)) + 0.25f) * 6.28318) * 0.21f * m_flCrouchWalkBob * cl_vm_dynsprintbob_intensity.GetFloat(); //vertical sway to counteract rotational tilt sway
	...
	angles.x += ((-cosf((flCrouchWalkBobTimeline - 0.25f)*12.56636f) + sinf((flCrouchWalkBobTimeline - 0.25f)*6.28318) * 0.2f) + 0.8f * (-cosf((flCrouchWalkBobTimeline - 0.25f)*12.56636f) + sinf((flCrouchWalkBobTimeline - 0.25f)*6.28318) * 0.2f)) * 0.15f * m_flCrouchWalkBob * cl_vm_dynsprintbob_intensity.GetFloat();//rotation step jolts
